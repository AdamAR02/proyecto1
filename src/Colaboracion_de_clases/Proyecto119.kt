...
class Banco{
    ...
    var Adam1:Cliente = Cliente("Adam", 0f)
    var Adam:Cliente = Cliente("Adam", 0f)
    fun operar() {
        ...
        Adam1.depositar(500f)
        Adam.extraer(100f)
    }


    fun depositosTotales() {
        val total = cliente1.monto + cliente2.monto + cliente3.monto + Adam1.monto + Adam.monto
